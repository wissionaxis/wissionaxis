...
const WhoWeAre = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center gap-8 py-16 bg-[#f3f4f6]">
      <div className="bg-[#3560B3] text-white p-8 rounded-lg flex-1 text-center md:text-left">
